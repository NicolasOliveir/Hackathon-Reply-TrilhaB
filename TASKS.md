...
| `I2-001` | Plano dos workers PO, Dev e QA | `EM_ANDAMENTO` | Nicolau Codex | `task/I2-001-workers-plan` | 2026-08-22 16:34 -03:00 | `I1-008` | `PLAN.md` e detalhamento das tarefas I2 no quadro | Planejar workers genéricos, ferramentas Dev/QA, gates e validação integral contra o documento Trilha B. |
