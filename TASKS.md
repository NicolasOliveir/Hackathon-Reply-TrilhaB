...
| `I1-007` | E2E da fatia distribuída e isolamento | `EM_ANDAMENTO` | MatheusSchimieguelSilva | `task/I1-007-e2e-distributed-slice` | 2026-08-22 16:20 -03:00 | `I1-002`, `I1-005`, `I1-006` | `tests/e2e/**`, roteiro e wiring final em `infra/**`/container do painel | Reserva publicada; escopo de integração registra a troca do último stub pelo painel real no Compose, necessária para o comando único e sem colisão com tarefas ativas. |
| `I1-008` | Gateway real Claude/Codex e primeiro worker LLM | `EM_ANDAMENTO` | Nicolau Codex | `task/I1-008-model-gateway` | 2026-08-22 16:21 -03:00 | `I1-005` | `services/control-api/app/model_gateway/**`, `api/internal/model-invocations`, worker LLM | Assunção autorizada; atualizar branch, validar provedores reais e substituir o primeiro papel fake. |
