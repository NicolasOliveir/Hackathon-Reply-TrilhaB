...
| `I1-003` | Painel React responsivo com mocks | `EM_REVISAO` | Nicolau Codex | `task/I1-003-painel-react` | 2026-08-22 14:05 -03:00 | — | `apps/control-panel/**` | Viewport mobile corrigido em `045b595`; 12 testes e build aprovados, com regressão coberta. |
