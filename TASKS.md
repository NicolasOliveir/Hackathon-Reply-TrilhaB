...
| `I2-003` | ArtifactStore, WorkspaceManager e runtime de ferramentas | `EM_REVISAO` | MatheusSchimieguelSilva | `task/I2-003-worker-runtime` | 2026-08-22 17:06 -03:00 | `I2-002` | `services/control-api/app/artifacts/**`, `workspace/**`, `runtime/tools/**` e APIs internas correspondentes | Commit `7af8f80` publicado; ArtifactStore, snapshots/workspaces, mounts Dev/QA, executor e APIs de heartbeat/artefato/falha validados por 65 testes focados, 167 da API e 9 de contrato. |
