...
| `I2-002` | Contratos, projeções e grafo dos workers | `CONCLUIDA` | Worker Contracts Codex | `task/I2-002-worker-contracts` | 2026-08-22 16:44 -03:00 | `I1-008`, `I2-001` | `packages/contracts/**`, contratos/projeções dos workers e state machine | Integrada na `main` em `561365b`; 7 testes aprovados; schemas, hashes, handoffs e `PO_COMPLETED` congelados. |
...
| `I2-004` | PO Worker real e backlog persistido | `EM_REVISAO` | PO Worker Codex | `task/I2-004-po-worker` | 2026-08-22 16:51 -03:00 | `I2-002` | `services/po-worker/**`, persistência/API de backlog e handoff PO -> Dev | Commits `19498eb`, `4fce119`, `0bab911`; 134 testes, 29 subtestes, PostgreSQL e imagem Docker aprovados; 2 skips POSIX no Windows. |
