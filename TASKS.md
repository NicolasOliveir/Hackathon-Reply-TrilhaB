...
| `I2-002` | Contratos, projeções e grafo dos workers | `EM_ANDAMENTO` | Worker Contracts Codex | `task/I2-002-worker-contracts` | 2026-08-22 16:44 -03:00 | `I1-008`, `I2-001` | `packages/contracts/**`, contratos/projeções dos workers e state machine | Congelar handoffs PO -> Dev -> QA -> runner antes da implementação paralela dos workers. |
