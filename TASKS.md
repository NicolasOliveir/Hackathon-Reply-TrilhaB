...
| `I2-006` | QA Worker e adapters | `EM_ANDAMENTO` | Nicolau QA Codex | `task/I2-006-qa-worker` | 2026-08-22 17:29 -03:00 | `I2-002`, `I2-003` | `services/qa-worker/**` | Takeover autorizado pelo usuário; implementar plano e testes reais mínimos por critério, sem declarar o próprio aceite. |
