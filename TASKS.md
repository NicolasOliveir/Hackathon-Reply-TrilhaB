...
| `I2-002` | Contratos, projeções e grafo dos workers | `EM_REVISAO` | Worker Contracts Codex | `task/I2-002-worker-contracts` | 2026-08-22 16:44 -03:00 | `I1-008`, `I2-001` | `packages/contracts/**`, contratos/projeções dos workers e state machine | Commits `33058e5` e `fba714d`; 7 testes aprovados; schemas, hashes, handoffs e `PO_COMPLETED` congelados. |
