...
| `I1-003` | Painel React responsivo com mocks | `EM_REVISAO` | Nicolau Codex | `task/I1-003-painel-react` | 2026-08-22 14:05 -03:00 | — | `apps/control-panel/**` | UX do briefing publicada em `29ed029`; lint, typecheck, 10 testes e build aprovados. |
