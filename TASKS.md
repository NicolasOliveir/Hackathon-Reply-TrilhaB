...
| `I1-002` | Compose, redes e fake worker | `EM_REVISAO` | MatheusSchimieguelSilva | `task/I1-002-compose-worker` | 2026-08-22 14:26 -03:00 | — | `infra/**`, `services/agent-worker/**` | Branch `5e75314`; Compose válido, 13 testes aprovados e smoke real com PostgreSQL saudável e callback `202` em 2026-08-22 14:35 -03:00. |
| `I1-003` | Painel React responsivo com mocks | `EM_ANDAMENTO` | Nicolau Codex | `task/I1-003-painel-react` | 2026-08-22 14:05 -03:00 | — | `apps/control-panel/**` | Refinamento mobile e melhoria da auditoria solicitados após revisão visual. |
