...
| `I1-003` | Painel React responsivo com mocks | `EM_REVISAO` | Nicolau Codex | `task/I1-003-painel-react` | 2026-08-22 14:05 -03:00 | — | `apps/control-panel/**` | Vite LAN publicado em `9d42609`; lint, typecheck, 10 testes e build aprovados. |
...
| `I1-005` | ContainerRuntime e despacho do fake worker | `EM_ANDAMENTO` | Arthur Monteiro | — | — | `I1-001`, `I1-002`, `I1-004` | `services/control-api/app/runtime/**`, `orchestration/**` | — |
