...
| `I2-003` | ArtifactStore, WorkspaceManager e runtime de ferramentas | `CONCLUIDA` | MatheusSchimieguelSilva | `task/I2-003-worker-runtime` | 2026-08-22 17:06 -03:00 | `I2-002` | `services/control-api/app/artifacts/**`, `workspace/**`, `runtime/tools/**` e APIs internas correspondentes | Integrada na `main` em `0dc2bce` após revisão independente; smoke Docker confirmou Dev RW, QA código RO e `/tests` RW com UID 10001; 172 testes da API e 9 de contrato aprovados. |
...
| `I2-005` | Dev Worker real | `EM_ANDAMENTO` | Dev Worker Codex | `task/I2-005-dev-worker` | 2026-08-22 17:29 -03:00 | `I2-002`, `I2-003` | `services/dev-worker/**` | Reserva publicada para implementar o Dev Worker em paralelo ao QA, consumindo somente a story congelada e produzindo entrega reproduzível. |
| `I2-006` | QA Worker e adapters | `EM_ANDAMENTO` | QA Worker Codex | `task/I2-006-qa-worker` | 2026-08-22 17:29 -03:00 | `I2-002`, `I2-003` | `services/qa-worker/**` | Reserva publicada para implementar o QA Worker em paralelo ao Dev, materializando testes por critério sem executar comandos nem declarar aceite. |
