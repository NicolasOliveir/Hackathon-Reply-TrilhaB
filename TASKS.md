...
| `I1-003` | Painel React responsivo com mocks | `EM_ANDAMENTO` | Nicolau Codex | `task/I1-003-painel-react` | 2026-08-22 14:05 -03:00 | — | `apps/control-panel/**` | Correção responsiva baseada em evidência visual de mobile/tablet. |
